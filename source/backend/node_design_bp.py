...
_NODE_SCHEMA = """{
  ...
  "total_resources_owned说明": "每5章统计一次：仅第5/10/15/…章节点携带此字段，其余章省略",
  "cool_type": "爽点类型（八选一）",
  "cool_structure": "爽点结构",
  "cool_contrast": "衬托方式",
  "cool_level": "爽点层级",
...
time / location / events / conflict / characters(必须带relation关系标签) / resources_gained / resources_used / total_resources_owned(**每5章统计一次：仅第5/10/15/…章节点携带，其余章省略**；滚动核算：上一统计点总资源 - 本段消耗合计 + 本段获得合计 = 本段总资源) / hook；埋收 bury/payoff 精确到章。
【资源分类口径（5类，必须写清【类别前缀】）】
...
【资源滚动铁律】resources_gained 列"本章新增获取"的资源；resources_used 列"本章使用/消耗/被抢走/破碎/过期/送人"的资源（已经使用/消耗掉的，必须在总资源滚动核算中消除扣减，禁止既写在 resources_used 又在总资源中原封不动）；total_resources_owned 每 5 章统计一次（仅第5/10/15/…章节点输出，其余章省略，系统会自动按滚动核算补齐中间章），统计截至该 5 章段落结束时主角实际仍拥有的全部资源明细，分 5 类列出，必须严格与上一统计点滚动（上一统计点total - 本段used合计 + 本段gained合计 = 本段total），不能凭空跳变。
