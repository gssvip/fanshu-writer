...
· 【强压迫场景·压迫语气差·硬卡（上下级权力层级明确的强制场景=必启用：监工/审讯/征兵/处罚/不平等交易契约/上级训话/封闭人身管制场所等）】
...
· 【对白自检 3 条必过】
  - ① 强压迫场景（上下级权力层级明确的强制场：监工/审讯/处罚/上级训话/封闭管制场所等）有没有做到上位者打断/威胁式反问/用词粗硬（3选1）+ 下位者话少30%或动作沉默代替回答（2选1）？
...
禁令6·禁强压迫场景对话语气同质化（上下级权力层级明确的强制场=监工/审讯/征兵/处罚/交易契约/上级训话/封闭管制场所等=必启用）：上位者语气差+下位者语气差必须按规则写，上下位者客气礼貌对答=直接重写【详见行文规范对白节·强压迫场景语气差硬卡】。
