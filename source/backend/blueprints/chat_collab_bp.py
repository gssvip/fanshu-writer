...
· 【对白自检 3 条必过】
  - ① 强压迫场景（上下级权力层级明确）有没有做到上位者打断/威胁式反问/用词粗硬 + 下位者话少或动作沉默代替回答？
...
禁令6·禁强压迫场景对话语气同质化（上下级权力层级明确=必启用）：上位者语气差+下位者语气差必须按规则写，上下位者客气礼貌对答=直接重写【详见行文规范对白节·强压迫场景语气差硬卡】。
