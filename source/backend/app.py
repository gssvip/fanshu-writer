...
SEED_SKILL_PACKS = [
    ...
    {'name': '玄幻小说文风', 'description': "【文风专用·玄幻/仙侠爽文 v2】男频玄幻爽文大神的通用文风：第三人称限知主跟主角；主角越平静、旁观越震惊的反差冷面落地，情绪绝不贴标签，靠小动作+体感+微表情；叙述句以逗号长句为主（20-35字串1-2个动作）、段数≤80/2400字、铁律A+禁令0全口径生效。", 'genre': 'fantasy', 'book_type': 'novel', 'icon': '⚔️',
...
- 段落是否大多 1–2 句成段？段内句号数是不是 ≤ 2？（硬卡4.1，>2 立即不合格）
