...
SEED_SKILL_PACKS = [
    ...
    {'name': '玄幻小说文风', 'description': "【文风专用·玄幻/仙侠爽文 v2】男频玄幻爽文大神的通用文风：第三人称限知主跟主角；主角越平静、旁观越震惊的反差冷面落地，情绪绝不贴标签，靠小动作+体感+微表情；段落（1–2句成段）、段数≤130/2400字、铁律A+禁令0全口径生效。", 'genre': 'fantasy', 'book_type': 'novel', 'icon': '⚔️',
...
## 长短句比例（含标点符号计字数）
- 短句：40%-60%，每句 1-20 字。用于回答、反问、动作、判断、悬念落点。
- 中句：20%-30%，每句 20-35 字。用于解释规则、交代背景、补充推理。
- 长句：10%-20%，每句 35-70 字。只用于复杂设定说明或必要场面描述。
- 超过70字的句子必须拆开。
...
- 短句占40%-60%（1-20字）？中句占20%-30%（20-35字）？长句控制在10%-20%（35-70字）？
- 句均字数是不是 12–22 字？段均句数是不是 ≤ 1.8？（硬卡4.3/4.4）
- 是否存在超过70字的句子？有则拆开。
...
- **冰山人物：有没有"他/她感到 + 情绪名词"？**（有则改"反常行为+小动作+体感+微表情"）
