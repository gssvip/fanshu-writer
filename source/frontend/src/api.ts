...
export const api = {
  ...
  smartFixFromReport: (bookId: string, reportId?: string, skillPackIds: string[] = [], volumeIds?: string[], signal?: AbortSignal) =>
    request<{ plan: Array<{ dim: string; label: string; issues: string[]; action: string; new_content: string; patches?: Array<{ original: string; rewritten: string }> }>; report_title: string; report_id: string }>(
  ...
  smartApplyFix: (bookId: string, fixes: Array<{ dim: string; new_content: string; patches?: Array<{ original: string; rewritten: string }> }>) =>
